package reportutilities.extentmodel;
...
import reportutilities.htmlmodel.TestStep;
...
{
	static final  Logger logger =LoggerFactory.getLogger(ExtentUtilities.class.getName()); 
...
return testCaseDetails;
	...
	public void log(TestCaseParam testCaseParam, TestStepModel testStepModel) {
	    ...
	    tsDetail.setTestCaseStatus(testStepModel.getTestStepStatus());
