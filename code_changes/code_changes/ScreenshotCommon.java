...
public class ScreenshotCommon
{
	...
	/// <returns></returns>
	public void getScreenShot(String screenshotPath, WebDriver driver) throws IOException 
	{
		try
		{
	...
	public String createDirectory(String directoryPath, String directoryName) throws IOException
	{
		try
		{
	...
	public String captureScreenShot(WebDriver driver, String testCaseName) throws IOException
	{
		...
		String screenshotPath = createDirectory(TestRunSettings.getResultsPath(), "Screenshot");
		...
		public String createTextFileArrayList(List<String> arraylist, String apiname) throws IOException
	{
	
		String screenshotPath = createDirectory(ReportContants.getResultsFolder(), "Screenshot");
